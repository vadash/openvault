...
describe('Unified Reflection Integration', () => {
    ...
    it('handles 1-reflection response (minimal)', async () => {
        ...
        const result = await generateReflections('Alice', [
            { id: 'ev_001', summary: 'Alice did something important', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] },
            { id: 'ev_002', summary: 'Alice met Bob', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] },
            { id: 'ev_003', summary: 'Alice fought a dragon', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] }
        ], {});
    ...
    it('handles empty evidence_ids gracefully', async () => {
        ...
        const result = await generateReflections('Alice', [
            { id: 'ev_001', summary: 'Event one', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] },
            { id: 'ev_002', summary: 'Event two', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] },
            { id: 'ev_003', summary: 'Event three', importance: 3, characters_involved: ['Alice'], witnesses: ['Alice'], type: 'event', embedding: [0.5, 0.5] }
        ], {});
